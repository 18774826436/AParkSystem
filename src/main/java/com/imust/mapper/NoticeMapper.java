...
public interface NoticeMapper {
	...
	//添加信息
	@Insert("insert into Notice(title,content,create_date,admin_id,admin_name) values(#{title},#{content},NOW(),#{admin_id},#{admin_name})")
	...
	@Select("select * from Notice order by create_date desc limit 0,10")
